...
export interface QueryTradeRankingParams {
     ...
     */
    time?: RangeType.M15 | RangeType.M30 | RangeType.H1 | RangeType.H6 | RangeType.H12 | RangeType.D1 | RangeType.D7 | RangeType.D30;
    /**
...
export interface QueryCollectionRankingParams {
     ...
     */
    sort_field?: 'volume_1d' | 'volume_7d' | 'volume_30d' | 'volume_total' | 'volume_change_1d' | 'volume_change_7d' | 'volume_change_30d' | 'sales_1d' | 'sales_7d' | 'sales_30d' | 'sales_total' | 'sales_change_1d' | 'sales_change_7d' | 'sales_change_30d' | 'floor_price' | 'market_cap';
    /**
     * Can be asc or desc. desc for default
     */
    sort_direction?: SortDirection;
...
export interface QueryWalletRankingParams {
     ...
     */
    sort_field: 'holding_volume' | 'buy_volume' | 'sell_volume' | 'realized_gains_volume' | 'holding_collections' | 'holding_nfts' | 'trade_count';
    /**
     * Can be asc or desc. desc for default
     */
    sort_direction: SortDirection;
