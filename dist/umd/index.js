(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.NftscanSDK = {}, global.axios));
    ...
    ***************************************************************************** */
    ...
    })(exports.EvmChain || (exports.EvmChain = {}));
    /**
     * The erc type of the NFT
     */
    exports.ErcType = void 0;
    (function (ErcType) {
        ErcType["ERC_721"] = "erc721";
        ErcType["ERC_1155"] = "erc1155";
    })(exports.ErcType || (exports.ErcType = {}));
    /**
     * The sort type
     */
    ...
    })(exports.NsError || (exports.NsError = {}));
    /**
    ...
    function invalidParamError(paramName, extMsg) {
        return Promise.reject(new NftscanError(exports.NsError.PARAM_ERROR, invalidParam(paramName, extMsg)));
    }
    function paramErrorDefault(msg) {
        return Promise.reject(new NftscanError(exports.NsError.PARAM_ERROR, msg));
    }
    function missingParamError(paramName) {
        return Promise.reject(new NftscanError(exports.NsError.PARAM_ERROR, missingParam(paramName)));
    }
    function invalidLimitError(max) {
        return Promise.reject(new NftscanError(exports.NsError.PARAM_ERROR, invalidParam('limit', "capped at ".concat(max))));
    }
    ...
    function apiKeyError() {
        var error = new NftscanError(exports.NsError.API_KEY_ERROR, 'The property "apiKey" cannot be empty.');
    ...
    function apiChainError(chain) {
        var error = new NftscanError(exports.NsError.API_CHAIN_ERROR, "The property \"chain\" is invalid, current is ---> ".concat(chain));
        console.error(error.msg);
    ...
    function initHttpConfig() {
        axios__default["default"].interceptors.request.use(function (config) {
            ...
            return Promise.reject(new NftscanError(exports.NsError.REQUEST_ERROR, error.message));
        });
        axios__default["default"].interceptors.response.use(function (response) {
            ...
            if (isEmpty(response.data)) {
                return Promise.reject(new NftscanError(exports.NsError.RESPONSE_DATA_EMPTY));
            }
    ...
    function nftscanGet(nftscanConfig, url, params) {
        ...
        return axios__default["default"].get("".concat(baseURL).concat(url), {
            params: params,
    ...
    function nftscanPost(nftscanConfig, url, data) {
        ...
        return axios__default["default"].post("".concat(baseURL).concat(url), data, { headers: { 'X-API-KEY': apiKey, 'X-FROM': 'js_sdk' } });
    }
    ...
    var NftscanEvmStatistic = /** @class */ (function (_super) {
        ...
        NftscanEvmStatistic.prototype.getCollectionTrade = function (contractAddress, time) {
            ...
            return nftscanGet(this.config, "".concat(NftscanConst.API.evm.statistic.getCollectionTrade).concat(contractAddress), { time: time || exports.RangeType.D1 });
        };
        /**
        ...
        NftscanEvmStatistic.prototype.getCollectionTrending = function (contractAddress, time) {
            ...
            return nftscanGet(this.config, "".concat(NftscanConst.API.evm.statistic.getCollectionTrending).concat(contractAddress), { time: time || exports.RangeType.D1 });
        };
        /**
        ...
        NftscanEvmStatistic.prototype.getMintRanking = function (time) {
            return nftscanGet(this.config, "".concat(NftscanConst.API.evm.statistic.getMintRanking), { time: time || exports.RangeType.D1 });
        };
        /**
         * Mint amount
        ...
        NftscanEvmStatistic.prototype.getMintAmount = function (time) {
            return nftscanGet(this.config, "".concat(NftscanConst.API.evm.statistic.getMintAmount), { time: time || exports.RangeType.D1 });
        };
        /**
         * Traders ranking
        ...
        NftscanEvmStatistic.prototype.getTradersRanking = function (time, tradeType) {
            return nftscanGet(this.config, "".concat(NftscanConst.API.evm.statistic.getTradersRanking), { time: time || exports.RangeType.D1, trade_type: tradeType || exports.TradeType.BUY });
        };
        /**
         * Gas ranking
    ...
    exports.EvmType = index$1;
    exports.NftscanEvm = NftscanEvm;
    exports.NftscanSolana = NftscanSolana;
    exports.SolanaType = index;
